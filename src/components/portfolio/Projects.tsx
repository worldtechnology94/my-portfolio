...
const Projects = () => {
  ...
  const getAssetPath = (path: string) => `${import.meta.env.BASE_URL}assets/projects/${path}`;

  // FoodiePal project images array - all 31 screenshots using public URLs
  const foodiePalImages = [
    getAssetPath('foodiepal/1 (2).PNG'),
    getAssetPath('foodiepal/2.PNG'),
    getAssetPath('foodiepal/3.PNG'),
    getAssetPath('foodiepal/4.PNG'),
    getAssetPath('foodiepal/5.PNG'),
    getAssetPath('foodiepal/6.PNG'),
    getAssetPath('foodiepal/7.PNG'),
    getAssetPath('foodiepal/8.PNG'),
    getAssetPath('foodiepal/9.PNG'),
    getAssetPath('foodiepal/10.PNG'),
    getAssetPath('foodiepal/11.PNG'),
    getAssetPath('foodiepal/12.PNG'),
    getAssetPath('foodiepal/13.PNG'),
    getAssetPath('foodiepal/14.PNG'),
    getAssetPath('foodiepal/16.PNG'),
    getAssetPath('foodiepal/17.PNG'),
    getAssetPath('foodiepal/18.PNG'),
    getAssetPath('foodiepal/19.PNG'),
    getAssetPath('foodiepal/20.PNG'),
    getAssetPath('foodiepal/21.PNG'),
    getAssetPath('foodiepal/22.PNG'),
    getAssetPath('foodiepal/23.PNG'),
    getAssetPath('foodiepal/24.PNG'),
    getAssetPath('foodiepal/25.PNG'),
    getAssetPath('foodiepal/26.PNG'),
    getAssetPath('foodiepal/27.PNG'),
    getAssetPath('foodiepal/28.PNG'),
    getAssetPath('foodiepal/29.PNG'),
    getAssetPath('foodiepal/30.PNG'),
    getAssetPath('foodiepal/31.PNG')
  ];

  // Dwella project images array - all 30 screenshots using public URLs
  const dwellaImages = [
    getAssetPath('dwella/1.PNG'),
    getAssetPath('dwella/2.PNG'),
    getAssetPath('dwella/3.PNG'),
    getAssetPath('dwella/4.PNG'),
    getAssetPath('dwella/5.PNG'),
    getAssetPath('dwella/6.PNG'),
    getAssetPath('dwella/7.PNG'),
    getAssetPath('dwella/8.PNG'),
    getAssetPath('dwella/9.PNG'),
    getAssetPath('dwella/10.PNG'),
    getAssetPath('dwella/11.PNG'),
    getAssetPath('dwella/12.PNG'),
    getAssetPath('dwella/13.PNG'),
    getAssetPath('dwella/14.PNG'),
    getAssetPath('dwella/15.PNG'),
    getAssetPath('dwella/16.PNG'),
    getAssetPath('dwella/17.PNG'),
    getAssetPath('dwella/18.PNG'),
    getAssetPath('dwella/19.PNG'),
    getAssetPath('dwella/20.PNG'),
    getAssetPath('dwella/21.PNG'),
    getAssetPath('dwella/22.PNG'),
    getAssetPath('dwella/23.PNG'),
    getAssetPath('dwella/24.PNG'),
    getAssetPath('dwella/25.PNG'),
    getAssetPath('dwella/26.PNG'),
    getAssetPath('dwella/27.PNG'),
    getAssetPath('dwella/28.PNG'),
    getAssetPath('dwella/29.PNG'),
    getAssetPath('dwella/30.PNG')
  ];

  // Zuvia project images array - all marketplace app screenshots using public URLs
  const zuviaImages = [
    getAssetPath('zuvia/1.PNG'),
    getAssetPath('zuvia/2.PNG'),
    getAssetPath('zuvia/3.PNG'),
    getAssetPath('zuvia/4.PNG'),
    getAssetPath('zuvia/5.PNG'),
    getAssetPath('zuvia/6.PNG'),
    getAssetPath('zuvia/7.PNG'),
    getAssetPath('zuvia/8.PNG'),
    getAssetPath('zuvia/9.PNG'),
    getAssetPath('zuvia/10.PNG'),
    getAssetPath('zuvia/11.PNG'),
    getAssetPath('zuvia/12.PNG'),
    getAssetPath('zuvia/13.PNG'),
    getAssetPath('zuvia/14.PNG'),
    getAssetPath('zuvia/15.PNG'),
    getAssetPath('zuvia/16.PNG'),
    getAssetPath('zuvia/17.PNG'),
    getAssetPath('zuvia/18.PNG'),
    getAssetPath('zuvia/19.PNG'),
    getAssetPath('zuvia/20.PNG'),
    getAssetPath('zuvia/21.PNG'),
    getAssetPath('zuvia/22.PNG'),
    getAssetPath('zuvia/23.PNG'),
    getAssetPath('zuvia/24.PNG'),
    getAssetPath('zuvia/25.PNG'),
    getAssetPath('zuvia/26.PNG'),
    getAssetPath('zuvia/27.PNG'),
    getAssetPath('zuvia/28.PNG'),
    getAssetPath('zuvia/feem_86083_IMG_1704.PNG')
  ];

  // XAI project images array - all screenshots using public URLs
  const anXaiImages = [
    getAssetPath('An XAI/1.jpg'),
    getAssetPath('An XAI/2.jpg'),
    getAssetPath('An XAI/3.jpg'),
    getAssetPath('An XAI/4.jpg'),
    getAssetPath('An XAI/5.png'),
    getAssetPath('An XAI/6.png'),
    getAssetPath('An XAI/7.png'),
    getAssetPath('An XAI/8.png'),
    getAssetPath('An XAI/9.png'),
    getAssetPath('An XAI/10.png'),
    getAssetPath('An XAI/12.png'),
    getAssetPath('An XAI/13.png'),
    getAssetPath('An XAI/14.png'),
    getAssetPath('An XAI/15.png'),
    getAssetPath('An XAI/16.png'),
    getAssetPath('An XAI/17.png'),
    getAssetPath('An XAI/19.jpg'),
    getAssetPath('An XAI/20.png'),
    getAssetPath('An XAI/21.png'),
    getAssetPath('An XAI/22.png'),
    getAssetPath('An XAI/23.jpg'),
  ];

  // Road Accident Dashboard images array
  const roadAccidentImages = [
    getAssetPath('Road Accident Dashboard/1.jpg')
  ];

  // HR Dashboard images array
  const hrDashboardImages = [
    getAssetPath('HR Dashboard/1.jpg')
  ];
